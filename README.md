...
1) Σύνδεση στον λογαριασμό: Για να συνδεθεί στον λογαριασμό του ο διαχειριστής αρκέι να πατήσει το Link "Login here" που βρίσκεται στην οθόνη εγγραφής. Μετά θα μεταφερθεί στην οθόνη εγγραφής όπου εκεί για να συνδεθεί πρέπει να βάλει το σωστό username και κωδικο. Συγκεκριμένα το username είναι "admin" και ο κωδικός είναι "@dm1n".
