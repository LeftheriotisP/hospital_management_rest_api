...
- requirements.txt: Περιέχει όλες τις απαραίτητες βιβλιοθήκες και τις συγκεκριμένες εκδόσεις τους που χρησιμοποιεί η εφαρμογή για να λειτουργήσει. Το συγκεκριμένο αρχείο το χρησιμοποιεί το αρχείο Dockerfile για να εγκαταστήσει τις αντίστοιχες βιβλιοθήκες κατά την δημιουργία των containers.
